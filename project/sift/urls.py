...
urlpatterns = patterns('project.sift.views',
    url(r'^logout/', 'logout'),
    url(r'^$', 'cat_tagger', name='cat_landing'),
    url(r'^m/', 'cat_tagger', name='cat_landing'),
    url(r'^mobile/', 'cat_tagger', name='cat_landing'),
    url(r'^about/$', 'cat_about', name='cat_about'),
    url(r'^tag/$', 'cat_tagger', name='cat_tagger'),
    url(r'^filter/$', 'cat_results', name='cat_results'),
    url(r'^connect/(?P<first>\d+)/(?P<second>\d+)/$', 'cat_connect'),
    url(r'^view-connection/(?P<pair_id>\d+)/$', 'cat_connection_permalink'),
    url(r'^connection-sbs/(?P<pair_id>\d+)/$', 'cat_side_by_side_image'),
    ...
    url(r'^cat/v1/photo-full/(?P<photo_id>\d+)/$', 'cat_photo_full'),
    url(r'^cat/v1/photo-full/(?P<photo_id>\d+)/(?P<photo_slug>.*)/$', 'cat_photo_full'),
